...
Int64.prototype.setb = function setb(pos, value) {
  assert(pos >= 0);
  ...
  if (pos < 32) {
    ...
    this.hi &= ~(0xff << (pos - 32));
    this.hi |= value << (pos - 32);
  }

  return this;
};

Int64.prototype.testb = function testb(pos) {
  assert(pos >= 0);
  ...
  if (pos < 32)
    return (this.lo >>> pos) & 0xff;

  return (this.hi >>> (pos - 32)) & 0xff;
};
