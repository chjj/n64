...
Int64.prototype.iadd = function iadd(b) {
  enforce(Int64.isInt64(b), 'operand', 'int64');
...
Int64.prototype.imul = function imul(b) {
  enforce(Int64.isInt64(b), 'multiplicand', 'int64');
...
Int64.prototype.idiv = function idiv(b) {
  ...
  enforce(Int64.isInt64(b), 'divisor', 'int64');
...
Int64.prototype.cmp = function cmp(b) {
  enforce(Int64.isInt64(b), 'value', 'int64');
...
Int64.prototype.fromNumber = function fromNumber(num, signed) {
  if (signed != null) {
    enforce(typeof signed === 'boolean', 'signed', 'boolean');
    this.signed = signed;
  }
...
Int64.fromObject = function fromObject(obj, signed) {
  return new Int64().fromObject(obj, signed);
};
