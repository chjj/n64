...
Int64.prototype.imul = function imul(b) {
  ...
  hi = (mul32(a.hi, b.lo) + mul32(b.hi, a.lo)) | 0;
  c = ((a.lo * b.lo) / 0x100000000) | 0;
...
Int64.prototype.testn = function testn(bit) {
  ...
  if (bit < 32)
    return ((this.lo >>> bit) & 1) === 1;

  return ((this.hi >>> (bit - 32)) & 1) === 1;
};
...
Int64.prototype.fromObject = function fromObject(num, signed) {
  ...
  assert(typeof num.hi === 'number');
  assert(typeof num.lo === 'number');

  this.hi = num.hi | 0;
  this.lo = num.lo | 0;
  this.signed = !!num.signed;
